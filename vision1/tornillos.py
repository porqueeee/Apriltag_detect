...
min=10000
count=0
img=cv2.imread("C:/Users/valef/Downloads/vision1/Archivos del curso/tornillos.jpg")
...
_, thresh=cv2.threshold(blur,150,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C)
